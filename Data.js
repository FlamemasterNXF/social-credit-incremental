...
//saving and loading
function save(){
    window.localStorage.setItem('sciSave', JSON.stringify(data))
}
function load() {
    let savedata = JSON.parse(window.localStorage.getItem('sciSave'))
...
//full reset
function fullReset(){
    window.localStorage.removeItem('sciSave')
    location.reload()
}
